...
public:
    ...
    PYBIND11_TYPE_CASTER(T, _py<std::is_integral<T>::value>("int", "float"));
};
...
public:
    ...
    PYBIND11_TYPE_CASTER(T, _py("None"));
};
...
public:
    ...
    static constexpr auto name = _py("capsule");
private:
    void *value = nullptr;
};
...
public:
    ...
    PYBIND11_TYPE_CASTER(bool, _py("bool"));
};
...
template <typename StringType, bool IsView = false> struct string_caster {
    ...
    PYBIND11_TYPE_CASTER(StringType, _py(PYBIND11_STRING_NAME));
...
public:
    ...
    static constexpr auto name = _py(PYBIND11_STRING_NAME);
...
public:
    ...
    static constexpr auto name = _py("Tuple[") + concat(make_caster<Ts>::name...) + _py("]");
...
template <typename T> struct handle_type_name { static constexpr auto name = _py<T>(); };
template <> struct handle_type_name<bytes> { static constexpr auto name = _py(PYBIND11_BYTES_NAME); };
template <> struct handle_type_name<int_> { static constexpr auto name = _py("int"); };
template <> struct handle_type_name<iterable> { static constexpr auto name = _py("Iterable"); };
template <> struct handle_type_name<iterator> { static constexpr auto name = _py("Iterator"); };
template <> struct handle_type_name<none> { static constexpr auto name = _py("None"); };
template <> struct handle_type_name<args> { static constexpr auto name = _py("*args"); };
template <> struct handle_type_name<kwargs> { static constexpr auto name = _py("**kwargs"); };
